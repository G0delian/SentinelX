...
#
get_filename_component(filename "/Users/izzattillakhodza/Desktop/myprojects/SentinelX/LIEF/third-party//spdlog-1.15.3.zip" ABSOLUTE)
get_filename_component(directory "/Users/izzattillakhodza/Desktop/myprojects/SentinelX/build/LIEF/lief_spdlog_project-prefix/src/lief_spdlog_project" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-lief_spdlog_project${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-lief_spdlog_project${i}")
