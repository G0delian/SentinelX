...
#
get_filename_component(filename "/Users/izzattillakhodza/Desktop/myprojects/SentinelX/LIEF/third-party//tcb-span-b70b0ff.zip" ABSOLUTE)
get_filename_component(directory "/Users/izzattillakhodza/Desktop/myprojects/SentinelX/build/LIEF/lief_span-prefix/src/lief_span" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-lief_span${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-lief_span${i}")
