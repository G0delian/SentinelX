...
#
get_filename_component(filename "/Users/izzattillakhodza/Desktop/myprojects/SentinelX/LIEF/third-party//json-3.12.0.zip" ABSOLUTE)
get_filename_component(directory "/Users/izzattillakhodza/Desktop/myprojects/SentinelX/build/LIEF/lief_libjson-prefix/src/lief_libjson" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-lief_libjson${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-lief_libjson${i}")
