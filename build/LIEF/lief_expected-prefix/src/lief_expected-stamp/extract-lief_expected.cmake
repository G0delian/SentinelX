...
#
get_filename_component(filename "/Users/izzattillakhodza/Desktop/myprojects/SentinelX/LIEF/third-party//expected-1.2.0.zip" ABSOLUTE)
get_filename_component(directory "/Users/izzattillakhodza/Desktop/myprojects/SentinelX/build/LIEF/lief_expected-prefix/src/lief_expected" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-lief_expected${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-lief_expected${i}")
