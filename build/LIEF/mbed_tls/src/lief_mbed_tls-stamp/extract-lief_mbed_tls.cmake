...
#
get_filename_component(filename "/Users/izzattillakhodza/Desktop/myprojects/SentinelX/LIEF/third-party//mbedtls-3.6.4.zip" ABSOLUTE)
get_filename_component(directory "/Users/izzattillakhodza/Desktop/myprojects/SentinelX/build/LIEF/mbed_src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-lief_mbed_tls${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-lief_mbed_tls${i}")
