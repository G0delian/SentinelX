...
#
get_filename_component(filename "/Users/izzattillakhodza/Desktop/myprojects/SentinelX/LIEF/third-party//frozen-f6dbec6.zip" ABSOLUTE)
get_filename_component(directory "/Users/izzattillakhodza/Desktop/myprojects/SentinelX/build/LIEF/lief_frozen-prefix/src/lief_frozen" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-lief_frozen${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-lief_frozen${i}")
